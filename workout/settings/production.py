...
workout_templates = os.path.join(BASE_DIR, *['workout', 'templates'])
workoutcal_templates = os.path.join(BASE_DIR, *['workoutcal', 'templates'])
...
TEMPLATES = [
    {
        ...
        'DIRS': [workout_templates, workoutcal_templates],
    }
